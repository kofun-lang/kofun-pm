...
| P2 manifest & lock | dependency surface, lock v1 resolution pinning, re-lock idempotence, and four named refusals — **landed**; v0.5.0 also lands bounded structural inspection of a lock v2 envelope and every named store snapshot, while the writer, metadata descriptor bijection, manifest/tool identity checks, and migration remain | [#14](https://github.com/kofun-lang/kofun-pm/issues/14), which supplies the verified metadata history and files; manifest binding remains [#5](https://github.com/kofun-lang/kofun-pm/issues/5) |
...
| P4 fetch | ADR 7 decides the static URL protocol, lock v2, explicit-fetch-only network authority, and no-replace semantics; v0.4.0 lands store admission and v0.5.0 lands bounded lock-envelope/named-store inspection, while acquisition, metadata parsing/bijection, the writer/migration, same-handle handoff, and offline build gate remain | [#14](https://github.com/kofun-lang/kofun-pm/issues/14); Kofun inputs are [#1258](https://github.com/kofun-lang/kofun/issues/1258), [#1264](https://github.com/kofun-lang/kofun/issues/1264), [#1499](https://github.com/kofun-lang/kofun/issues/1499), [#1551](https://github.com/kofun-lang/kofun/issues/1551), [#1577](https://github.com/kofun-lang/kofun/issues/1577), and [#1578](https://github.com/kofun-lang/kofun/issues/1578) upstream |
